        ...
        <div class="cwb-auth-card">
            ...
            <div id="authModalContent">
                ...
                <div id="authStepSignIn" class="cwb-auth-step">
                    <p style="font-size: 0.8rem; color: #64748b; margin-bottom: 1.25rem;">Authorized staff, managers, and volunteers must sign in with their account to access CWB Operations.</p>
