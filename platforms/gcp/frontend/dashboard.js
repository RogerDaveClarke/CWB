...
function operationalState(boat) { if (boat.availability === "maintenance") return "maintenance"; if (boat.batteryServiceStatus === "charging") return "charging"; if (boat.batteryServiceStatus === "verification") return "verification"; if (isRentalOverdue(boat) || isOutsideZone(boat)) return "overdue"; if (boat.batteryMonitoringEnabled && boat.availability === "available" && (boat.batteryServiceStatus !== "ready" || boat.batteryHealth === "unknown" || !batteryReadingIsFresh(boat))) return "battery-unverified"; if (boat.batteryMonitoringEnabled && boat.availability === "available" && ["red", "critical"].includes(boat.batteryHealth)) return "battery-low"; if (boat.availability === "available" || (boat.mooring === "Tied Up at Dock" && !boat.timeOut)) return "available"; return "rented"; }
...
function dockActionContent(boat, status) {
    ...
    const checkoutDisabled = boat.batteryMonitoringEnabled && (boat.batteryServiceStatus !== "ready" || boat.batteryHealth === "critical" || boat.batteryHealth === "unknown" || !batteryReadingIsFresh(boat) || (boat.batteryHealth === "red" && !canOverride));
